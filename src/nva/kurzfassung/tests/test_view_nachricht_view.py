...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_nachricht_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='nachricht-view'
        )
        self.assertTrue(view.__name__ == 'nachricht-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in nachricht-view'
        # )

    def test_nachricht_view_not_matching_interface(self):
