...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_zwei_spalten_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='zwei-spalten-view'
        )
        self.assertTrue(view.__name__ == 'zwei-spalten-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in zwei-spalten-view'
        # )

    def test_zwei_spalten_view_not_matching_interface(self):
